...
export const article: Article = {
  ...
  title: "Black Seed and Honey: The Sunnah Pairing Malaysians Look For",
  heading: "Black seed and honey: why Malaysians look for this pairing",
  description:
    "Habbatus sauda and honey are the two most-searched Sunnah foods in Malaysia. What the pairing is, why the trio with dates exists, and what it honestly does and does not do.",
  primaryKeyword: "habbatus sauda madu",
  keywords: [
    "habbatus sauda madu",
    "black seed honey",
    "khasiat habbatus sauda",
    "sunnah food Malaysia",
  ...
  figureAlt:
    "Black seeds in a wooden scoop beside a small corked bottle of dark oil.",
  ...
  blocks: [
    ...
    {
      type: "paragraph",
      text: "Of everything in a Malaysian wellness aisle, habbatus sauda is the ingredient most people can name before they can describe it. It is searched for by name, asked for by name, and printed in large letters on jars precisely because it carries recognition that no marketing budget can buy.",
    },
    {
      type: "quote",
      text: "The black seed is a remedy for every illness except death.",
      attribution: "Narrated in Sahih al-Bukhari",
    },
    {
      type: "paragraph",
      text: "That narration is why the seed occupies the place it does in Muslim households. It is also worth being careful with: a hadith explains why an ingredient is honoured. It is not a claim a food seller may legally repeat as a product promise, and a brand that leans on it to sell you something is using your faith as a marketing device.",
    },
    {
      type: "heading",
      text: "Why is black seed paired with honey specifically?",
      id: "why-paired",
    },
    {
      type: "list",
    ...
    {
      type: "heading",
      text: "What is the Sunnah trio — madu, kurma, habbatus sauda?",
      id: "the-trio",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Whole seed, ground seed, or oil — does it matter?",
      id: "seed-forms",
    },
    {
      type: "table",
      caption: "The three forms you will find on Malaysian shelves",
      columns: ["Form", "What it is like", "Worth knowing"],
      rows: [
        ["Whole seed", "Visible black specks in the jar", "Looks convincing, but a whole seed swallowed intact passes through largely unbroken"],
        ["Ground seed", "Blend looks darker, slightly gritty", "Distributes evenly through honey; what most quality blends use"],
        ["Seed oil", "Smooth, strong peppery smell", "Concentrated and sharp; usually sold on its own rather than blended"],
      ],
    },
    {
      type: "paragraph",
      text: "Visible whole seeds are often a presentation choice — they make the jar look authentic on a shelf. That is not a criticism, but do not read specks as proof of a better blend.",
    },
    {
      type: "heading",
      text: "What does black seed honey actually do?",
      id: "what-it-does",
    },
    {
      type: "paragraph",
    ...
    {
      type: "cta",
      heading: "Black seed is one of ten",
      text: "SUBUR blends habbatus sauda with raw honeycomb, saffron, ginseng and six more — every one of them named on the label.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Ground seed distributes evenly through honey so every spoonful is roughly the same, while a whole seed swallowed intact largely passes through unbroken. Visible specks make a jar look authentic but are not evidence of a better blend.",
    },
    {
      q: "Can I add black seed honey to hot drinks?",
      a: "Let the drink cool to warm rather than boiling first. Adding raw honey blends to boiling liquid wastes much of what you paid for. Taking it straight from the spoon avoids the question entirely.",
    },
    {
  ...
  related: ["how-to-identify-pure-honey", "honey-and-garlic"],
};
