...
export const article: Article = {
  slug: "habbatus-sauda-dan-madu",
  title: "Habbatus Sauda dan Madu: Gandingan Sunnah yang Dicari di Malaysia",
  heading: "Habbatus sauda dan madu: kenapa gandingan ini dicari",
  description:
    "Habbatus sauda dan madu ialah dua makanan Sunnah paling dicari di Malaysia. Apa gandingan ini, kenapa wujud trio dengan kurma, dan apa yang ia lakukan dan tidak lakukan.",
  primaryKeyword: "habbatus sauda madu",
  keywords: [
    "habbatus sauda madu",
    "khasiat habbatus sauda",
    "madu kurma habbatus sauda",
    "makanan sunnah",
    "habbatus sauda Malaysia",
  ],
  ...
  figureAlt:
    "Biji habbatus sauda dalam senduk kayu di sebelah botol kecil bertutup gabus berisi minyak gelap.",
  category: "Bahan",
  blocks: [
    {
      type: "answer",
    ...
    {
      type: "paragraph",
      text: "Daripada segala yang ada di rak kesihatan di Malaysia, habbatus sauda ialah bahan yang paling ramai boleh sebut namanya sebelum mereka boleh menerangkannya. Ia dicari mengikut nama, diminta mengikut nama, dan dicetak besar-besar pada balang justeru kerana ia membawa pengiktirafan yang tidak boleh dibeli dengan bajet pemasaran.",
    },
    {
      type: "quote",
      text: "Habbatus sauda ialah penawar bagi setiap penyakit kecuali mati.",
      attribution: "Diriwayatkan dalam Sahih al-Bukhari",
    },
    {
      type: "paragraph",
      text: "Riwayat itulah sebabnya biji ini mendapat tempat sedemikian dalam rumah tangga Muslim. Ia juga perlu dilayan dengan berhati-hati: sebuah hadis menerangkan kenapa sesuatu bahan itu dimuliakan. Ia bukan dakwaan yang boleh diulang oleh penjual makanan sebagai janji produk, dan jenama yang bersandar padanya untuk menjual sesuatu sedang menggunakan iman anda sebagai alat pemasaran.",
    },
    {
      type: "heading",
      text: "Kenapa habbatus sauda digandingkan dengan madu?",
      id: "kenapa-gandingan",
    },
    {
      type: "list",
    ...
    {
      type: "heading",
      text: "Apa itu trio Sunnah — madu, kurma, habbatus sauda?",
      id: "trio",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Biji penuh, biji kisar, atau minyak — adakah ia penting?",
      id: "bentuk-biji",
    },
    {
      type: "table",
      caption: "Tiga bentuk yang anda akan jumpa di rak Malaysia",
      columns: ["Bentuk", "Rupanya", "Perlu diketahui"],
      rows: [
        ["Biji penuh", "Bintik hitam kelihatan dalam balang", "Nampak meyakinkan, tetapi biji penuh yang ditelan bulat-bulat banyak yang melalui badan tanpa pecah"],
        ["Biji kisar", "Campuran nampak lebih gelap, sedikit berpasir", "Bertabur sekata dalam madu; inilah yang digunakan kebanyakan campuran berkualiti"],
        ["Minyak biji", "Licin, bau pedas yang kuat", "Pekat dan tajam; biasanya dijual berasingan dan bukan dicampur"],
      ],
    },
    {
      type: "paragraph",
      text: "Biji penuh yang kelihatan selalunya satu pilihan persembahan — ia menjadikan balang nampak tulen di rak. Itu bukan satu kritikan, tetapi jangan anggap bintik-bintik itu sebagai bukti campuran yang lebih baik.",
    },
    {
      type: "heading",
      text: "Apa sebenarnya yang madu habbatus sauda lakukan?",
      id: "apa-ia-lakukan",
    },
    {
      type: "paragraph",
    ...
    {
      type: "cta",
      heading: "Habbatus sauda salah satu daripada sepuluh",
      text: "SUBUR menggabungkan habbatus sauda dengan sarang madu mentah, safron, ginseng dan enam lagi — setiap satunya dinamakan pada label.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Biji kisar bertabur sekata dalam madu supaya setiap sudu lebih kurang sama, manakala biji penuh yang ditelan bulat-bulat banyak yang melalui badan tanpa pecah. Bintik yang kelihatan menjadikan balang nampak tulen tetapi bukan bukti campuran yang lebih baik.",
    },
    {
      q: "Boleh saya campurkan madu habbatus sauda dalam minuman panas?",
      a: "Biarkan minuman itu suam dahulu, bukan mendidih. Memasukkan campuran madu mentah ke dalam air mendidih membazirkan sebahagian besar apa yang anda bayar. Mengambilnya terus dari sudu mengelakkan persoalan ini sama sekali.",
    },
    {
  ...
  related: ["madu-dan-halia", "sarang-madu-boleh-dimakan"],
};
