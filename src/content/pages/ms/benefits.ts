...
export const page: Article = {
  ...
  figureAlt:
    "Seorang lelaki menyenduk Subur Honey dari balang, dengan sarang lebah mentah dan segelas teh di atas meja di sebelahnya.",
  category: "Khasiat",
  blocks: [
    {
      type: "answer",
    ...
    {
      type: "heading",
      text: "Madu Subur baik untuk apa?",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Ramai pasangan mengambil Subur bersama setiap pagi. Lihat <a href=\"/ms/blog/madu-suami-isteri/\">bagaimana madu sesuai dalam rutin harian suami isteri</a> untuk gambaran penuh.",
        },
      ],
    },
    {
      type: "heading",
      text: "Kenapa sarang madu tulen, bukan madu terproses?",
      id: "raw-honeycomb",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Bagaimana cara mengambil Madu Subur untuk manfaat penuh campuran ini?",
      id: "how-to-take",
    },
    {
      type: "steps",
    ...
    {
      type: "cta",
      heading: "Lihat campuran sepuluh ramuan penuh",
      text: "Setiap ramuan dalam Madu Subur, apa ia dan kenapa ia ada di situ.",
      label: "Terokai ramuan",
    },
  ],
  faqs: [
    {
